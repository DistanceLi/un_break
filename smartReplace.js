...
async function downloader_jd() {
  if (/require\(['"`]{1}.\/jdCookie.js['"`]{1}\)/.test(remoteContent))
    await download(
      'https://github.com/wintjade/un_break/raw/master/src/jdCookie.js',
      './jdCookie.js',
      '京东Cookies'
    )
  if (remoteContent.indexOf('jdFruitShareCodes') > 0) {
    await download(
      'https://github.com/wintjade/un_break/raw/master/src/jdFruitShareCodes.js',
      './jdFruitShareCodes.js',
      '东东农场互助码'
    )
    await download(
      'https://github.com/wintjade/un_break/raw/master/utils/jdShareCodes.js',
  ...
  if (remoteContent.indexOf('jdPetShareCodes') > 0) {
    await download(
      'https://github.com/wintjade/un_break/raw/master/src/jdPetShareCodes.js',
      './jdPetShareCodes.js',
      '京东萌宠'
    )
    await download(
  ...
  if (remoteContent.indexOf('jdPlantBeanShareCodes') > 0) {
    await download(
      'https://github.com/wintjade/un_break/raw/master/src/jdPlantBeanShareCodes.js',
  ...
  if (remoteContent.indexOf('jdSuperMarketShareCodes') > 0) {
    await download(
      'https://github.com/wintjade/un_break/raw/master/src/jdSuperMarketShareCodes.js',
  ...
  if (remoteContent.indexOf('jdFactoryShareCodes') > 0) {
    await download(
      'https://github.com/wintjade/un_break/raw/master/src/jdFactoryShareCodes.js',
  ...
  if (remoteContent.indexOf('jdDreamFactoryShareCodes') > 0) {
    await download(
      'https://github.com/wintjade/un_break/raw/master/src/jdDreamFactoryShareCodes.js',
  ...
  if (
    ...
    await download(
      'https://github.com/wintjade/un_break/raw/master/src/jdJxncTokens.js',
      './jdJxncTokens.js',
      '京喜农场Token'
    )
    await download(
      'https://github.com/wintjade/un_break/raw/master/src/jdJxncShareCodes.js',
      './jdJxncShareCodes.js',
      '京喜农场分享码'
    )
    await download(
      'https://github.com/wintjade/un_break/raw/master/src/USER_AGENTS.js',
      './USER_AGENTS.js',
      'USER_AGENTS'
    )
  }
...
async function downloader_notify() {
  await download(
    'https://github.com/wintjade/un_break/raw/master/src/sendNotify.js',
    './sendNotify.js',
    '统一通知'
  )
}

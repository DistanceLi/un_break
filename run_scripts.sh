...
REPO_URL="https://github.com/wintjade/un_break"
REPO_BRANCH="master"
[ ! -d ~/un_break ] && git clone -b "$REPO_BRANCH" $REPO_URL ~/un_break
...
cd ~/un_break
echo "拉取最新源码"
git config --global user.email "winterxuc@gmail.com"
git config --global user.name "wintjade"
